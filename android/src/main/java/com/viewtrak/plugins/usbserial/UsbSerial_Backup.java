...
import com.viewtrak.plugins.usbserial.Utils.DeviceItem;
...
public class UsbSerial_Backup implements SerialInputOutputManager.Listener {
    ...
    public String echo(String value) {
        if (this.readCall != null) {
            for (int i=0;i<5; i++) {
                ...
                jsObject.put("data", "receiving the data from callback"+i);
                this.readCall.resolve(jsObject);
            }
        }
        return value;
    }
